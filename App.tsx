  ...
  const filterList = <T extends Wine>(list: T[], filters: SearchFilters, isHistoryList: boolean = false): T[] => {
    ...
    return list.filter(item => {
      ...
      if (!isHistoryList) {
        ...
        const historyEntry = item as any as HistoryEntry;
        if (filters.consumptionRating !== undefined && historyEntry.consumptionRating !== filters.consumptionRating) return false;
      }
      return true;
    });
  };
  ...
  return (
    <div className={settings.theme === 'dark' ? 'dark' : ''}>
      <div className="bg-stone-200 dark:bg-stone-950 h-screen w-full flex justify-center overflow-hidden">
        ...
        {/* SearchModal adapté à l'onglet actif avec suggestions globales */}
        <SearchModal 
          isOpen={isSearchOpen} 
