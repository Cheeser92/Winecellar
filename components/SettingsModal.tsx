        ...
        <div className="p-6 space-y-8 overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2 p-1 bg-stone-50 dark:bg-stone-800/50 rounded-xl border border-stone-100 dark:border-stone-800">
                <button onClick={() => setFontSize('small')} className={`flex-1 py-2 text-xs font-semibold rounded-lg transition-all ${localSettings.fontSize === 'small' ? 'bg-white dark:bg-stone-700 shadow-sm text-rose-900 dark:text-white' : 'text-stone-500 dark:text-stone-400 hover:bg-white/50 dark:hover:bg-stone-700/50'}`}>{t('font_small')}</button>
                <button onClick={() => setFontSize('medium')} className={`flex-1 py-2 text-sm font-semibold rounded-lg transition-all ${(!localSettings.fontSize || localSettings.fontSize === 'medium') ? 'bg-white dark:bg-stone-700 shadow-sm text-rose-900 dark:text-white' : 'text-stone-500 dark:text-stone-400 hover:bg-white/50 dark:hover:bg-stone-700/50'}`}>{t('font_medium')}</button>
                <button onClick={() => setFontSize('large')} className={`flex-1 py-2 text-base font-semibold rounded-lg transition-all ${localSettings.fontSize === 'large' ? 'bg-white dark:bg-stone-700 shadow-sm text-rose-900 dark:text-white' : 'text-stone-500 dark:text-stone-400 hover:bg-white/50 dark:hover:bg-stone-700/50'}`}>{t('font_large')}</button>
            </div>
          </div>
          <div className="space-y-3">
